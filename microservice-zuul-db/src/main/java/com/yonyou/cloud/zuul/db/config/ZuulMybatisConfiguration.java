...
//    }
    ...
    public void setEnvironment(Environment environment) {
        ...
        this.url = propertyResolver.getProperty("zuul.db.url");
        this.userName= propertyResolver.getProperty("zuul.db.username");
        this.password = propertyResolver.getProperty("zuul.db.password");
        this.driveClassName = propertyResolver.getProperty("zuul.db.driver-class-name");
